...
## Requirements
 * **RT ROBOT & RT SERVER** (the control software for robots) version >= **2.14.x** (for CS-Series). If the version of the robot's control software is lower than this, it is recommended to upgrade it.
