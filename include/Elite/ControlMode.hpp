...
enum class ControlMode : int {
    ...
    MODE_POSE = 5,              // Set when cartesian pose control is active.(Not use now, coming soon)
    MODE_FREEDRIVE = 6,         // Set when freedrive mode is active.(Not use now, coming soon)
